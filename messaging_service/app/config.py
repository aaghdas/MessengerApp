...
# Absoluter Pfad zur .env Datei des Messaging Service.
...
# die vom Messaging Service aus der .env Datei benötigt werden.
class Settings(BaseSettings):
    # Verbindung zur PostgreSQL-Datenbank.
    # Der echte Wert wird aus messaging_service/.env geladen.
    DATABASE_URL: str
...
# Zentrale Settings-Instanz für den Messaging Service.
settings = Settings()