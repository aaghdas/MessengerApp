# Dependencies für den User Service.
#
# Diese Datei enthält wiederverwendbare FastAPI-Dependencies.
# Aktuell wird hier der eingeloggte Benutzer über ein JWT Access Token ermittelt.
#
# Die technische JWT-Prüfung liegt im shared-Bereich:
# shared/auth/jwt.py
#
# Dadurch kann dieselbe Token-Logik später auch von anderen Services
# wie dem Messaging Service verwendet werden.
